...
function MerchantLogin() {
  ...
  async function login(e) {
    ...
    try {
      await Axios.post(
        "http://localhost:5000/authMerchant/merchantLogin",
        loginData
      );
    } catch (err) {
      if (err.response) {
                ...
                <div className="row">
                  <div className="col-md-6 ml-auto">
                    ...
                    <p style={{ marginTop: "20px", marginBottom: "30px" }}>
                      Titan Machinery offers high precision suppliers machinery
                      at industry leading prices. Exporters & Importers from the
                      world's largest online B2B marketplace. Logistics Service.
                      Most Popular. Production Monitoring. Trade Assurance.
                    </p>
                    {/* <a href="#">REgister toShop Now</a> */}
                  </div>
                </div>
              </div>
            </div>
